...
a = pd.read_csv("0416_spec_cc.csv")
...
engine = create_engine("mysql+mysqldb://root:"+"123123"+"@localhost/gidseller", encoding='utf-8')
conn = engine.connect()
a.to_sql(name='copy_cetizen', con=engine, if_exists='append', index=False)
